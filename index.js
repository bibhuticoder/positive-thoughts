...
const generateImage = async () => {
    registerFont('Cardo-Regular.ttf', { family: 'Cardo' });
    registerFont('Oswald.ttf', { family: 'Oswald' });
    registerFont('DancingScript.ttf', { family: 'DancingScript' });
    ...
    // pattern
    let image = await loadImage(`pattern${random(1, 5)}.png`);
